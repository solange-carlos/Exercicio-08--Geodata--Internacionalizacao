...
/**
 * Created by Solange Carlos on 10/12/17.
 */
    ...
    public static Pais[] buscarPaises(String url, String regiao) throws IOException {
        ...
        try {
            ...
            for(int i = 0; i < vetor.length(); i++){
                ...
                try {
                    pais.setDemonimo(latlng.getString(0));
                } catch (Exception e) {
                    pais.setDemonimo(0);
                }
                ...
                try {
                    pais.setSubRegiao(latlng.getString(0));
                } catch (Exception e) {
                    pais.setSubRegiao(0);
                }

                try {
                    pais.setRegiao(latlng.getString(0));
                } catch (Exception e) {
                    pais.setRegiao(0);
                }

                try {
                    pais.setCapital(latlng.getString(0));
                } catch (Exception e) {
                    pais.setCapital(0);
                }

                try {
                    pais.setBandeira(latlng.getString(0));
                } catch (Exception e) {
                    pais.setBandeira(0);
                }
                ...
                try {
                    pais.setCodigo3(latlng.getString(0));
                } catch (Exception e) {
                    pais.setCodigo3(0);
                }

                try {
                    pais.setNome(latlng.getString(0));
                } catch (Exception e) {
                    pais.setNome(0);
                }
